    ...
    />
      ...
      <div className='h-full flex grow' style={{width: 'calc(100% - 80px)'}}>
        <div className='ml-3 mr-0 grow'>
          ...
          <p className='text-gray-500 text-[14px]'>{project.building.name} {project.floor.floor_num<0?"B"+Math.abs(project.floor.floor_num):project.floor.floor_num}階 {project.room_name}</p>
